...
namespace coda {
  /*!
   * class to handle printf style formating using a format string containing
   * specifiers that get replaced with argument values
   */
  class format {
    public:
    // template methods
     ...
     */
    template <typename T> format &args(const T &value) {
